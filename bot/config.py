...
# Bot Configuration
API_ID = os.getenv("API_ID", "34446649")
...
ADMINS = list(map(int, os.getenv("ADMINS", "7892805795").split()))

# List of additional IDs to add
ADDITIONAL_IDS = [7892805795]  # Add as many as needed
...
PAID_USERS = list(map(int, os.getenv("PAID_USERS", "7892805795").split()))
